...
public class SQLDelect {
		...
		public void DeleteFilm_Type(String mid,String tid) {
			...
			try {
					connection=DbcpJdbcUtil.getConnection();
					String sql="delete from Film_Type where movieId ="+mid+"and typeId="+tid;
		...
		public void DeletePurchase(String mid,String uid,String cid) {
			...
			try {
					connection=DbcpJdbcUtil.getConnection();
					String sql="delete from Purchase where movieId ="+mid+"and userId ="+uid+"and cinemaId ="+cid;
		...
		public void DeleteRelease(String mid,String cid) {
			...
			try {
					connection=DbcpJdbcUtil.getConnection();
					String sql="delete from Release where movieId ="+mid+"and cinemaId="+cid;
